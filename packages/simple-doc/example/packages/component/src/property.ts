...
export class Property {
   ...
   * @param [options.exposure] A [`PropertyExposure`](https://liaison.dev/docs/v1/reference/property-exposure) object specifying how the property should be exposed to remote access.
   *
   ...
   *
   * @returns A [`PropertyExposure`](https://liaison.dev/docs/v1/reference/property-exposure) object.
   *
   * @example
   * ```
   ...
   *
   * @param [exposure] A [`PropertyExposure`](https://liaison.dev/docs/v1/reference/property-exposure) object.
   *
   * @example
   * ```
